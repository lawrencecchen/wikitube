...
*/
  ...
  function ya(a, b, c, d) {
    try {
      ...
      return (a.h.l = null), ra(a.h, g), za(a);
    }
    a.h.l = null;
    d.call(a.h, f);
    return za(a);
  ...
  function za(a) {
    for (; a.h.h; )
      try {
        var b = a.i(a.h);
        if (b) return (a.h.s = !1), { value: b.value, done: !1 };
      } catch (c) {
  ...
  function Aa(a) {
    this.next = function (b) {
      qa(a.h);
      a.h.l ? (b = ya(a, a.h.l.next, b, a.h.u)) : (a.h.u(b), (b = za(a)));
      return b;
    };
    this.throw = function (b) {
      qa(a.h);
      a.h.l ? (b = ya(a, a.h.l["throw"], b, a.h.u)) : (ra(a.h, b), (b = za(a)));
      return b;
    };
  ...
  r("WeakMap", function (a) {
    ...
    b.prototype.set = function (k, l) {
      ...
      e(k);
      if (!Ba(k, g)) throw Error("WeakMap key fail: " + k);
      k[g][this.h] = l;
      return this;
    };
    b.prototype.get = function (k) {
      return d(k) && Ba(k, g) ? k[g][this.h] : void 0;
    };
    b.prototype.has = function (k) {
      return d(k) && Ba(k, g) && Ba(k[g], this.h);
    };
    b.prototype.delete = function (k) {
      return d(k) && Ba(k, g) && Ba(k[g], this.h) ? delete k[g][this.h] : !1;
    };
    return b;
  });
  r("Map", function (a) {
      ...
      if (m && Ba(h.data_, l))
        for (h = 0; h < m.length; h++) {
          ...
          if ((k !== k && q.key !== q.key) || k === q.key)
            return { id: l, list: m, index: h, A: q };
        }
  ...
  r("Promise", function (a) {
    ...
    b.prototype.va = function (g) {
      ...
      else if (g instanceof b) this.xa(g);
      else {
        a: switch (typeof g) {
          case "object":
            var h = null != g;
    ...
    b.prototype.ca = function (g) {
      ...
      "function" == typeof h ? this.ya(h, g) : this.o(g);
    };
    ...
    var f = new c();
    b.prototype.xa = function (g) {
      var h = this.l();
      g.W(h.resolve, h.reject);
    };
  ...
  function Ia(a) {
    return (
      (Object.prototype.hasOwnProperty.call(a, Ja) && a[Ja]) || (a[Ja] = ++Ka)
    );
  }
  ...
  var tb = RegExp(
    ...
    sb = {},
    wb = new rb("about:invalid#zClosurez", sb);
  var xb;
  a: {
    var yb = z.navigator;
    if (yb) {
    ...
    if (void 0 === eb) {
      ...
      if (d && d.createPolicy) {
        try {
          ...
          z.console && z.console.error(e.message);
        }
        eb = c;
      } else eb = c;
    }
    a = (c = eb) ? c.createHTML(a) : a;
    return new Bb(a, b, Ab);
  }
  var Db = RegExp(
    "^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$"
  );
  ...
  var Nb = H("Opera"),
    ...
    Qb =
      H("Gecko") &&
      !(-1 != xb.toLowerCase().indexOf("webkit") && !H("Edge")) &&
      !(H("Trident") || H("MSIE")) &&
      !H("Edge"),
    Rb = -1 != xb.toLowerCase().indexOf("webkit") && !H("Edge");
  function Sb() {
    var a = z.document;
  ...
  if (z.document && Ob) {
    var Zb = Sb();
    Yb = Zb ? Zb : parseInt(Xb, 10) || void 0;
  } else Yb = void 0;
  var $b = Yb;
  var ac = Lb() || H("iPod"),
    bc = H("iPad"),
  ...
  var dc = {},
    ec = null;
  var fc = { ib: { value: !0, configurable: !0 } };
  var gc = Object,
    hc = gc.freeze,
    ic = [];
  Array.isArray(ic) && !Object.isFrozen(ic) && Object.defineProperties(ic, fc);
  hc.call(gc, ic);
  var J = window;
  hb("csi.gstatic.com");
  hb("googleads.g.doubleclick.net");
  hb("pagead2.googlesyndication.com");
  hb("partner.googleadservices.com");
  hb("pubads.g.doubleclick.net");
  hb("securepubads.g.doubleclick.net");
  hb("tpc.googlesyndication.com");
  function jc(a, b) {
    this.width = a;
    this.height = b;
  }
  ...
  var rc = {
      Sa: "allow-forms",
      Ta: "allow-modals",
      Ua: "allow-orientation-lock",
      Va: "allow-pointer-lock",
      Wa: "allow-popups",
      Xa: "allow-popups-to-escape-sandbox",
      Ya: "allow-presentation",
      Za: "allow-same-origin",
      ab: "allow-scripts",
      bb: "allow-top-navigation",
      cb: "allow-top-navigation-by-user-activation",
    },
    tc = Ra(function () {
      return sc();
    });
  function uc() {
    var a = nc(document, "IFRAME"),
      b = {};
    G(tc(), function (c) {
  ...
  function xc() {
      ...
      for (p = 0; 80 > p; p++) {
        if (40 > p)
          if (20 > p) {
            var P = v ^ (x & (A ^ v));
            var D = 1518500249;
          } else (P = x ^ A ^ v), (D = 1859775393);
        else
          60 > p
            ? ((P = (x & A) | (v & (x | A))), (D = 2400959708))
            : ((P = x ^ A ^ v), (D = 3395469782));
        P =
          ((((q << 5) | (q >>> 27)) & 4294967295) + P + K + D + t[p]) &
          4294967295;
        K = v;
        v = A;
        A = ((x << 30) | (x >>> 2)) & 4294967295;
        x = q;
        q = P;
      }
    ...
    function c(q, t) {
      if ("string" === typeof q) {
        ...
        for (var p = [], x = 0, A = q.length; x < A; ++x)
          p.push(q.charCodeAt(x));
        q = p;
      }
      t || (t = q.length);
      p = 0;
      if (0 == l)
        for (; p + 64 < t; ) b(q.slice(p, p + 64)), (p += 64), (m += 64);
      for (; p < t; )
        if (((f[l++] = q[p++]), m++, 64 == l))
          for (l = 0, b(f); p + 64 < t; )
            b(q.slice(p, p + 64)), (p += 64), (m += 64);
    }
    function d() {
      var q = [],
        t = 8 * m;
      ...
      b(f);
      for (p = t = 0; 5 > p; p++)
        for (var x = 24; 0 <= x; x -= 8) q[t++] = (e[p] >> x) & 255;
      return q;
    }
    ...
    return {
      ...
      Ca: function () {
        for (var q = d(), t = "", p = 0; p < q.length; p++)
          t +=
            "0123456789ABCDEF".charAt(Math.floor(q[p] / 16)) +
            "0123456789ABCDEF".charAt(q[p] % 16);
        return t;
      },
    };
  }
  function yc(a, b, c) {
    ...
    return d && a && b ? [b, zc(wc(d), a, c || null)].join(" ") : null;
  }
  function zc(a, b, c) {
    var d = [],
      e = [];
  ...
  n.isEnabled = function () {
    ...
    this.set("TESTCOOKIESENABLED", "1", { ea: 60 });
  ...
  n.remove = function (a, b, c) {
    ...
    this.set(a, "", { ea: 0, path: b, domain: c });
    return d;
  };
  n.isEmpty = function () {
  ...
  var Dc = new Cc("undefined" == typeof document ? null : document);
  function Ec(a) {
    return !!Bc.FPA_SAMESITE_PHASE2_MOD || !(void 0 === a || !a);
  }
  function Fc(a, b, c, d) {
    (a = z[a]) || (a = new Cc(document).get(b));
    return a ? yc(a, c, d) : null;
  }
  function Gc(a) {
    var b = void 0 === b ? !1 : b;
    var c = wc(String(z.location.href)),
      d = [];
    var e = b;
    e = void 0 === e ? !1 : e;
    var f = z.__SAPISID || z.__APISID || z.__3PSAPISID || z.__OVERRIDE_SID;
    Ec(e) && (f = f || z.__1PSAPISID);
    if (f) e = !0;
    else {
      var g = new Cc(document);
      f =
        g.get("SAPISID") ||
        g.get("APISID") ||
        g.get("__Secure-3PAPISID") ||
        g.get("SID");
      Ec(e) && (f = f || g.get("__Secure-1PAPISID"));
      e = !!f;
    }
    e &&
      ((e = (c =
      ...
      (e = e ? yc(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e),
      c &&
        Ec(b) &&
        ((b = Fc("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) &&
          d.push(b),
        (a = Fc("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) &&
          d.push(a)));
  ...
  function Tc() {
    if (z.Promise && z.Promise.resolve) {
      ...
      Sc = function () {
        var b = Wc;
        "function" !== typeof z.setImmediate ||
        (z.Window &&
          z.Window.prototype &&
          !H("Edge") &&
  ...
  $c.prototype.update = function (a, b) {
    if (null != a) {
      ...
      for (var c = b - this.blockSize, d = 0, e = this.m, f = this.i; d < b; ) {
        if (0 == f) for (; d <= c; ) ad(this, a, d), (d += this.blockSize);
        if ("string" === typeof a)
          for (; d < b; ) {
    ...
    if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
      ...
      if (null == c) {
        if (a.constructor && a.constructor instanceof Function) {
          ...
          else if (((c = a.constructor), dd[c])) c = dd[c];
          else {
            c = String(c);
            if (!dd[c]) {
              var f = /function\s+([^\(]+)/m.exec(c);
              dd[c] = f ? f[1] : "[Anonymous]";
            }
            c = dd[c];
          }
  ...
  hd.prototype.next = function () {
    return hd.prototype.h.call(this);
  };
  ...
  function id(a) {
    if (a instanceof jd || a instanceof kd || a instanceof ld) return a;
  ...
  jd.prototype.C = function () {
    return new kd(this.j());
  };
  jd.prototype[Symbol.iterator] = function () {
    return new ld(this.j());
  };
  ...
  kd.prototype.next = function () {
    return kd.prototype.h.call(this);
  };
  kd.prototype[Symbol.iterator] = function () {
    return new ld(this.j);
  };
  ...
  function nd(a, b) {
    ...
    if (1 < c) {
      ...
      if (a instanceof nd)
        for (c = od(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
  ...
  n.delete = function (a) {
    return qd(this.i, a)
      ? (delete this.i[a],
        --this.size,
        this.j++,
        this.h.length > 2 * this.size && pd(this),
        !0)
      : !1;
  };
  function pd(a) {
  ...
  n.set = function (a, b) {
    qd(this.i, a) || ((this.size += 1), this.h.push(a), this.j++);
    this.i[a] = b;
  };
  n.forEach = function (a, b) {
    for (var c = od(this), d = 0; d < c.length; d++) {
      var e = c[d],
        f = this.get(e);
      a.call(b, f, e, this);
    }
  ...
  n.keys = function () {
    return id(this.C(!0)).i();
  };
  n.values = function () {
    return id(this.C(!1)).i();
  };
  n.entries = function () {
    var a = this;
    return Yc(this.keys(), function (b) {
      return [b, a.get(b)];
    });
  };
  n.C = function (a) {
  ...
  var td = (function () {
    ...
    try {
      z.addEventListener("test", Fa, b), z.removeEventListener("test", Fa, b);
    } catch (c) {}
    return a;
  })();
  function ud(a, b) {
  ...
  Ad.prototype.add = function (a, b, c, d, e) {
    ...
    -1 < g
      ? ((b = a[g]), c || (b.V = !1))
      : ((b = new yd(b, this.src, f, !!d, e)), (b.V = c), a.push(b));
    return b;
  };
  ...
  function Cd(a, b) {
    ...
    c in a.listeners &&
      Ua(a.listeners[c], b) &&
      (zd(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.h--));
  }
  function Bd(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var f = a[e];
      if (!f.T && f.listener == b && f.capture == !!c && f.Y == d) return e;
    }
    return -1;
  }
  ...
  function Gd(a, b, c, d, e) {
    if (d && d.once) Hd(a, b, c, d, e);
    else if (Array.isArray(b))
      for (var f = 0; f < b.length; f++) Gd(a, b[f], c, d, e);
    else
      (c = Id(c)),
        a && a[wd]
          ? a.Z(b, c, C(d) ? !!d.capture : !!d, e)
          : Jd(a, b, c, !1, d, e);
  }
  function Jd(a, b, c, d, e, f) {
    if (!b) throw Error("Invalid event type");
    var g = C(e) ? !!e.capture : !!e,
      h = Kd(a);
    h || (a[Dd] = h = new Ad(a));
    c = h.add(b, c, d, g, f);
    if (!c.h) {
  ...
  function Hd(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      (c = Id(c)),
        a && a[wd]
          ? a.h.add(String(b), c, !0, C(d) ? !!d.capture : !!d, e)
          : Jd(a, b, c, !0, d, e);
  }
  function Od(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      ((d = C(d) ? !!d.capture : !!d), (c = Id(c)), a && a[wd])
  ...
  function Pd(a) {
    if ("number" !== typeof a && a && !a.T) {
      ...
      if (b && b[wd]) Cd(b.h, a);
        ...
        Fd--;
        (c = Kd(b))
          ? (Cd(c, a), 0 == c.h && ((c.src = null), (b[Dd] = null)))
          : zd(a);
      }
    }
  }
  ...
  L.prototype.Z = function (a, b, c, d) {
  ...
  function de(a, b) {
    a.i || (2 != a.h && 3 != a.h) || ee(a);
    a.l ? (a.l.next = b) : (a.i = b);
    a.l = b;
  }
  function Zd(a, b, c, d) {
    var e = Yd(null, null, null);
    e.h = new Ud(function (f, g) {
      e.i = b
        ? function (h) {
            try {
              var k = b.call(d, h);
      ...
      e.onRejected = c
        ? function (h) {
            try {
              var k = c.call(d, h);
              void 0 === k && h instanceof $d ? g(h) : f(k);
            } catch (l) {
              g(l);
            }
          }
  ...
  Ud.prototype.u = function () {
    for (var a; (a = be(this)); ) ce(this, a, this.h, this.s);
    this.o = !1;
  };
  function ce(a, b, c, d) {
    ...
    if (b.h) (b.h.j = null), he(b, c, d);
      ...
      try {
        b.j ? b.i.call(b.context) : he(b, c, d);
      } catch (e) {
        ie.call(null, e);
      }
    Kc(Xd, b);
  ...
  n.clear = function (a) {
    if (a) {
      var b = this.i[a];
      b && (b.forEach(this.U, this), delete this.i[a]);
  ...
  me.prototype.set = function (a, b) {
    void 0 === b ? this.h.remove(a) : this.h.set(a, Td(b));
  };
  ...
  function pe(a) {
    return void 0 === a || a instanceof oe ? a : new oe(a);
  }
  ne.prototype.set = function (a, b) {
    ne.G.set.call(this, a, pe(b));
  };
  ne.prototype.i = function (a) {
    a = ne.G.get.call(this, a);
  ...
  qe.prototype.set = function (a, b, c) {
    if ((b = pe(b))) {
      if (c) {
        if (c < Date.now()) {
          qe.prototype.remove.call(this, a);
          return;
        }
        b.expiration = c;
      }
    ...
    qe.G.set.call(this, a, b);
  };
  qe.prototype.i = function (a) {
    var b = qe.G.i.call(this, a);
    if (b) {
      var c = b.creation,
        d = b.expiration;
  ...
  n.set = function (a, b) {
    this.h.setAttribute(ye(a), b);
    ze(this);
  };
  n.get = function (a) {
    a = this.h.getAttribute(ye(a));
    if ("string" !== typeof a && null !== a)
      throw "Storage mechanism: Invalid value was encountered";
    return a;
  };
  n.remove = function (a) {
    this.h.removeAttribute(ye(a));
    ze(this);
  };
  n.C = function (a) {
    var b = 0,
  ...
  Ae.prototype.C = function (a) {
    var b = this.i.C(!0),
      ...
      d = new hd();
    d.h = function () {
      for (var e = b.h(); e.substr(0, c.h.length) != c.h; ) e = b.h();
  ...
  var Be,
    ...
    De = z.window,
    Ee =
      (null === (Be = null === De || void 0 === De ? void 0 : De.yt) ||
      void 0 === Be
        ? void 0
        : Be.config_) ||
      (null === (Ce = null === De || void 0 === De ? void 0 : De.ytcfg) ||
      void 0 === Ce
        ? void 0
        : Ce.data_) ||
      {};
  ...
  function Fe(a) {
    ...
    1 < b.length
      ? (Ee[b[0]] = b[1])
      : 1 === b.length && Object.assign(Ee, b[0]);
  }
  function N(a, b) {
    return a in Ee ? Ee[a] : b;
  }
  var Ge = [];
  function He(a) {
  ...
  function Ne(a) {
    ...
    try {
      if ((a = a || window.event)) {
        this.event = a;
        for (var b in a) b in Me || (this[b] = a[b]);
  ...
  Ne.prototype.stopImmediatePropagation = function () {
    this.event &&
      ((this.event.cancelBubble = !0),
      this.event.stopImmediatePropagation &&
        this.event.stopImmediatePropagation());
  };
  var $a = z.ytEventsEventsListeners || {};
  E("ytEventsEventsListeners", $a);
  var Oe = z.ytEventsEventsCounter || { count: 0 };
  E("ytEventsEventsCounter", Oe);
  function Pe(a, b, c, d) {
    d = void 0 === d ? {} : d;
    a.addEventListener &&
          ...
          k.args = [
            {
              ...
              value: f[1],
              query: a,
              method: Ze == m ? "unchanged" : m,
            },
          ];
          We.hasOwnProperty(l) || Ke(k);
        }
    }
    return c;
  }
  ...
  function cf(a) {
    ...
    c && d
      ...
      : (a = d
          ? Fb(b) == d &&
            (Number(b.match(Db)[4] || null) || null) ==
              (Number(a.match(Db)[4] || null) || null)
          : !0);
    return a;
  }
  function Ye(a) {
    return a && a.match(Ve) ? a : decodeURIComponent(a.replace(/\+/g, " "));
  }
  function Q(a) {
    a = df(a);
  ...
  function hf(a, b, c) {
    ...
    return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : Te(a, c || 0);
  }
  function lf(a) {
  ...
  function mf(a) {
    ...
    try {
      ...
      e.u_java =
        !!J.navigator &&
        "unknown" !== typeof J.navigator.javaEnabled &&
        !!J.navigator.javaEnabled &&
        J.navigator.javaEnabled();
      J.screen &&
        ((e.u_h = J.screen.height),
        (e.u_w = J.screen.width),
        (e.u_ah = J.screen.availHeight),
        (e.u_aw = J.screen.availWidth),
        (e.u_cd = J.screen.colorDepth));
      J.navigator &&
        J.navigator.plugins &&
        (e.u_nplug = J.navigator.plugins.length);
      J.navigator &&
        J.navigator.mimeTypes &&
        (e.u_nmime = J.navigator.mimeTypes.length);
    } catch (na) {}
    h = b.h;
    try {
      var k = h.screenX;
    ...
    try {
      (t = h.innerWidth), (p = h.innerHeight);
    } catch (na) {}
    try {
      var v = h.screen.availWidth;
      var K = h.screen.availTop;
    } catch (na) {}
    k = [x, A, k, l, v, K, m, q, t, p];
    l = b.h.top;
    try {
      var P = (l || window).document,
        D = "CSS1Compat" == P.compatMode ? P.documentElement : P.body;
      var O = new jc(D.clientWidth, D.clientHeight).round();
    } catch (na) {
      O = new jc(-12245933, -12245933);
    }
    P = O;
    O = {};
    D = new Hc();
    z.SVGElement && z.document.createElementNS && D.set(0);
    l = uc();
    l["allow-top-navigation-by-user-activation"] && D.set(1);
    l["allow-popups-to-escape-sandbox"] && D.set(2);
    z.crypto && z.crypto.subtle && D.set(3);
    z.TextDecoder && z.TextEncoder && D.set(4);
    D = Ic(D);
    O.bc = D;
    O.bih = P.height;
    O.biw = P.width;
  ...
  var qf = {
    ...
    rf =
      "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address"
        ...
        .concat(
          fa(
            "client_dev_mss_url client_dev_regex_map client_dev_root_url expflag jsfeat jsmode client_rollout_override".split(
              " "
            )
          )
        ),
  ...
  function tf(a, b) {
    b = void 0 === b ? {} : b;
    var c = cf(a),
      d = Q("web_ajax_ignore_global_headers_if_set"),
      e;
    for (e in qf) {
      var f = N(qf[e]);
      !f || (!c && Fb(a)) || (d && void 0 !== b[e]) || (b[e] = f);
    }
    if (c || !Fb(a))
    ...
    if (c || !Fb(a)) b["X-YouTube-Ad-Signals"] = $e(mf(void 0));
    return b;
  }
  function uf(a) {
    var b = window.location.search,
      c = Fb(a);
    Q("debug_handle_relative_url_for_query_forward_killswitch") ||
      c ||
      !cf(a) ||
      (c = document.location.hostname);
    var d = Eb(a.match(Db)[5] || null);
    d =
      (c =
        c &&
      ...
      f = yf(
        ...
        function (k) {
          if (!e) {
            ...
            if (l || q || t) m = zf(a, c, k, b.convertToSafeHtml);
            if (l)
            ...
            q = b.context || z;
            l
              ? b.onSuccess && b.onSuccess.call(q, k, m)
              : b.onError && b.onError.call(q, k, m);
  ...
  function wf(a, b) {
    b.includeDomain &&
      (a =
        ...
        a);
    var c = N("XSRF_FIELD_NAME", void 0);
    if ((b = b.urlParams)) b[c] && delete b[c], (a = bf(a, b || {}, !0));
    return a;
  }
  function xf(a, b) {
    var c = N("XSRF_FIELD_NAME", void 0),
      ...
      e = b.postBody || "",
      f = b.postParams,
      g = N("XSRF_FIELD_NAME", void 0),
      h;
    b.headers && (h = b.headers["Content-Type"]);
    b.excludeXsrf ||
      (Fb(a) && !b.withCredentials && Fb(a) != document.location.hostname) ||
      "POST" != b.method ||
    ...
    !sf &&
      a &&
      "POST" != b.method &&
      ((sf = !0), Je(Error("AJAX request with postData should use POST")));
    return e;
  }
  function zf(a, b, c, d) {
    var e = null;
    switch (b) {
      case "JSON":
        ...
        break;
      case "XML":
        if ((a = (a = c.responseXML) ? Af(a) : null))
          (e = {}),
            G(a.getElementsByTagName("*"), function (g) {
              e[g.tagName] = Bf(g);
            });
    }
    d && Cf(e);
  ...
  function yf(a, b, c, d, e, f, g) {
    ...
    Q("debug_forward_web_query_parameters") && (a = uf(a));
    k.open(c, a, !0);
    f && (k.responseType = f);
  ...
  function Hf(a, b, c, d, e) {
    ...
    if (a)
      if (c && !Ef("cobalt"))
        a &&
          (a instanceof rb ||
            ((a = "object" == typeof a && a.S ? a.R() : String(a)),
            vb.test(a)
              ? (a = new rb(a, sb))
              : ((a = String(a)),
                (a = a.replace(/(%0A|%0D)/g, "")),
                (a =
                  (b = a.match(ub)) && tb.test(b[1]) ? new rb(a, sb) : null))),
          (a = a || wb),
          a instanceof rb && a.constructor === rb
            ? (a = a.h)
            : (Ga(a), (a = "type_error:SafeUrl")),
          "about:invalid#zClosurez" === a || a.startsWith("data")
            ...
            : (a instanceof Bb ||
                ...
                (c = null),
                b && a.na && (c = a.ma()),
                (a = Cb(jb(b && a.S ? a.R() : String(a)), c))),
              a instanceof Bb && a.constructor === Bb
                ? (a = a.h)
                : (Ga(a), (a = "type_error:SafeHtml")),
              (a = encodeURIComponent(String(Td(a.toString()))))),
          /^[\s\xa0]*$/.test(a) ||
            ((a = mc("IFRAME", {
      ...
      else if (e) yf(a, b, "POST", e, d);
      else if (N("USE_NET_AJAX_FOR_PING_TRANSPORT", !1) || d)
        yf(a, b, "GET", "", d);
      else {
        b: {
          try {
            var f = new Qa({ url: a });
            if ((f.j && f.i) || f.l) {
              var g = Eb(a.match(Db)[5] || null);
              var h = !(!g || !g.endsWith("/aclk") || "1" !== Kb(a, "ri"));
              break b;
            }
          } catch (k) {}
          h = !1;
        }
        h ? (If(a) ? (b && b(), (c = !0)) : (c = !1)) : (c = !1);
        c || Jf(a, b);
      }
  }
  function Kf(a, b, c) {
    c = void 0 === c ? "" : c;
    If(a, c) ? b && b() : Hf(a, b, void 0, void 0, c);
  }
  function If(a, b) {
    try {
      if (
  ...
  var Lf = z.ytPubsubPubsubInstance || new M(),
    Mf = z.ytPubsubPubsubSubscribedKeys || {},
    Nf = z.ytPubsubPubsubTopicToKeys || {},
    Of = z.ytPubsubPubsubIsSynchronous || {};
  M.prototype.subscribe = M.prototype.subscribe;
  M.prototype.unsubscribeByKey = M.prototype.U;
  M.prototype.publish = M.prototype.O;
  M.prototype.clear = M.prototype.clear;
  E("ytPubsubPubsubInstance", Lf);
  E("ytPubsubPubsubTopicToKeys", Nf);
  E("ytPubsubPubsubIsSynchronous", Of);
  E("ytPubsubPubsubSubscribedKeys", Mf);
  var Pf = window,
    R =
      Pf.ytcsi && Pf.ytcsi.now
        ? Pf.ytcsi.now
        : Pf.performance &&
          Pf.performance.timing &&
          Pf.performance.now &&
          Pf.performance.timing.navigationStart
        ? function () {
            return Pf.performance.timing.navigationStart + Pf.performance.now();
          }
        : function () {
            return new Date().getTime();
          };
  var Qf = ef("initial_gel_batch_timeout", 2e3),
    Rf = Math.pow(2, 16) - 1,
    Sf = null,
    Tf = 0,
    Uf = void 0,
    ...
    Xf = 0,
    Yf = !0,
    Zf = z.ytLoggingTransportGELQueue_ || new Map();
  E("ytLoggingTransportGELQueue_", Zf);
  var $f = z.ytLoggingTransportTokensToCttTargetIds_ || {};
  E("ytLoggingTransportTokensToCttTargetIds_", $f);
  function ag(a, b) {
    if ("log_event" === a.endpoint) {
      var c = "";
      a.X
        ? (c = "visitorOnlyApprovedKey")
        : a.H && (($f[a.H.token] = bg(a.H)), (c = a.H.token));
      var d = Zf.get(c) || [];
      Zf.set(c, d);
      d.push(a.payload);
      b && (Uf = new b());
      a = ef("tvhtml5_logging_max_batch") || ef("web_logging_max_batch") || 100;
      b = R();
      d.length >= a
        ? cg({ writeThenSend: !0 })
        : 10 <= b - Xf && (dg(), (Xf = b));
  ...
  function eg(a, b) {
    if ("log_event" === a.endpoint) {
      ...
      d.set(c, [a.payload]);
      b && (Uf = new b());
      return new Ud(function (e) {
        Uf && Uf.isReady() ? fg(d, e, { bypassNetworkless: !0 }) : e();
      });
    }
  }
  function cg(a) {
    ...
    new Ud(function (b) {
      ...
      Wf = 0;
      Uf && Uf.isReady() ? (fg(Zf, b, a), Zf.clear()) : (dg(), b());
    });
  }
  function dg() {
    ...
    window.clearTimeout(Vf);
    var a = N("LOGGING_BATCH_TIMEOUT", ef("web_gel_debounce_ms", 1e4));
    Q("shorten_initial_gel_batch_timeout") && Yf && (a = Qf);
    Vf = Te(function () {
      cg({ writeThenSend: !0 });
    }, a);
  }
  function fg(a, b, c) {
    ...
    for (var g = a.next(); !g.done; g = a.next()) {
      ...
      h = bb({ context: gg(d.config_ || hg()) });
      h.events = k;
      (k = $f[g]) && ig(h, g, k);
      delete $f[g];
      g = "visitorOnlyApprovedKey" === g;
      jg(h, e, g);
      Q("send_beacon_before_gel") &&
        window.navigator &&
        window.navigator.sendBeacon &&
        !c.writeThenSend &&
        Kf("/generate_204");
  ...
  function jg(a, b, c) {
    ...
    !c &&
      (b = N("EVENT_ID", void 0)) &&
      ((c = N("BATCH_CLIENT_COUNTER", void 0) || 0) ||
        (c = Math.floor((Math.random() * Rf) / 2)),
      c++,
      c > Rf && (c = 1),
      Fe("BATCH_CLIENT_COUNTER", c),
      ...
      Sf &&
        ...
        Q("log_gel_rtt_web") &&
        (a.previousBatchInfo = {
          serializedClientEventId: Sf,
          roundtripMs: String(Tf),
        }),
      (Sf = b),
      (Tf = 0));
  }
  ...
  var lg = z.ytLoggingGelSequenceIdObj_ || {};
  E("ytLoggingGelSequenceIdObj_", lg);
  function mg() {
    if (!z.matchMedia) return "WEB_DISPLAY_MODE_UNKNOWN";
    try {
      return z.matchMedia("(display-mode: standalone)").matches
        ? "WEB_DISPLAY_MODE_STANDALONE"
        : z.matchMedia("(display-mode: minimal-ui)").matches
        ? "WEB_DISPLAY_MODE_MINIMAL_UI"
        : z.matchMedia("(display-mode: fullscreen)").matches
        ? "WEB_DISPLAY_MODE_FULLSCREEN"
        : z.matchMedia("(display-mode: browser)").matches
  ...
  E("ytglobal.prefsUserPrefsPrefs_", B("ytglobal.prefsUserPrefsPrefs_") || {});
  var ng = {
  ...
  function qg() {
    return "INNERTUBE_API_KEY" in Ee && "INNERTUBE_API_VERSION" in Ee;
  }
  function hg() {
    return {
      innertubeApiKey: N("INNERTUBE_API_KEY", void 0),
      innertubeApiVersion: N("INNERTUBE_API_VERSION", void 0),
      Fa: N("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
      Ga: N("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
      innertubeContextClientVersion: N(
        "INNERTUBE_CONTEXT_CLIENT_VERSION",
        void 0
      ),
      Ia: N("INNERTUBE_CONTEXT_HL", void 0),
      Ha: N("INNERTUBE_CONTEXT_GL", void 0),
      Ja: N("INNERTUBE_HOST_OVERRIDE", void 0) || "",
      La: !!N("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
      Ka: !!N("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
  ...
  function gg(a) {
    ...
    c = [];
    var d = N("EXPERIMENTS_FORCED_FLAGS", {});
    for (e in d) c.push({ key: e, value: String(d[e]) });
    var e = N("EXPERIMENT_FLAGS", {});
    for (var f in e)
      f.startsWith("force_") &&
        void 0 === d[f] &&
    ...
    if ("WEB" === f || "MWEB" === f || 1 === f || 2 === f) {
      if (!Q("web_include_display_mode_killswitch")) {
        var g;
        b.client.mainAppWebInfo =
          null != (g = b.client.mainAppWebInfo) ? g : {};
        b.client.mainAppWebInfo.webDisplayMode = mg();
      }
    } else if (
      ((g = b.client.clientName),
      ("WEB_REMIX" === g || 76 === g) &&
        !Q("music_web_display_mode_killswitch"))
    ) {
      var h;
      b.client.pa = null != (h = b.client.pa) ? h : {};
      b.client.pa.webDisplayMode = mg();
    }
    a.appInstallData &&
      ((b.client.configInfo = b.client.configInfo || {}),
      (b.client.configInfo.appInstallData = a.appInstallData));
    N("DELEGATED_SESSION_ID") &&
      !Q("pageid_as_header_web") &&
      (b.user = { onBehalfOfUser: N("DELEGATED_SESSION_ID") });
    a: {
      if ((h = pg())) {
        a = ng[h.type || "unknown"] || "CONN_UNKNOWN";
        h = ng[h.effectiveType || "unknown"] || "CONN_UNKNOWN";
    ...
    Q("web_log_effective_connection_type") &&
      ((a = pg()),
      (a =
        null !== a && void 0 !== a && a.effectiveType
          ? og.hasOwnProperty(a.effectiveType)
            ? og[a.effectiveType]
    ...
    g = b.client;
    f = {};
    e = u(Object.entries(af(N("DEVICE", ""))));
  ...
  function rg(a, b, c) {
    c = void 0 === c ? {} : c;
    var d = { "X-Goog-Visitor-Id": c.visitorData || N("VISITOR_DATA", "") };
    if (b && b.includes("www.youtube-nocookie.com")) return d;
    (b = c.fb || N("AUTHORIZATION")) ||
      (a ? (b = "Bearer " + B("gapi.auth.getToken")().eb) : (b = Gc([])));
    b &&
      ((d.Authorization = b),
      (d["X-Goog-AuthUser"] = N("SESSION_INDEX", 0)),
      Q("pageid_as_header_web") &&
        (d["X-Goog-PageId"] = N("DELEGATED_SESSION_ID")));
    return d;
  }
  function sg(a) {
    a = Object.assign({}, a);
    ...
    if (b) {
      var c = new $c();
      c.update(N("INNERTUBE_API_KEY", void 0));
      c.update(b);
      b = c.digest();
      c = 3;
      Ha(b);
  ...
  function tg(a) {
    var b = new ue();
    (b = b.isAvailable() ? (a ? new Ae(b, a) : b) : null) ||
      ((a = new ve(a || "UserDataSharedStore")),
      (b = a.isAvailable() ? a : null));
    this.h = (a = b) ? new qe(a) : null;
    this.i = document.domain || window.location.hostname;
  }
  tg.prototype.set = function (a, b, c, d) {
    c = c || 31104e3;
    this.remove(a);
    if (this.h)
      try {
  ...
  tg.prototype.get = function (a, b) {
    ...
    if (d && (c = Dc.get("" + a, void 0)) && ((c = unescape(c)), b))
      try {
        c = JSON.parse(c);
      } catch (e) {
  ...
  tg.prototype.remove = function (a) {
    ...
    var b = this.i;
    Dc.remove("" + a, "/", void 0 === b ? "youtube.com" : b);
  };
  var ug;
  function vg() {
    ug || (ug = new tg("yt.innertube"));
    return ug;
  }
  function wg(a, b, c, d) {
    if (d) return null;
    d = vg().get("nextId", !0) || 1;
    var e = vg().get("requests", !0) || {};
    e[d] = {
      method: a,
      request: b,
      authState: sg(c),
    ...
    vg().set("nextId", d + 1, 86400, !0);
    vg().set("requests", e, 86400, !0);
    return d;
  }
  function xg(a) {
    var b = vg().get("requests", !0) || {};
    delete b[a];
    vg().set("requests", b, 86400, !0);
  }
  function yg(a) {
    var b = vg().get("requests", !0);
    if (b) {
      for (var c in b) {
        ...
        if (!(6e4 > Math.round(R()) - d.requestTime)) {
          ...
          ab(e, f) &&
            ((e = d.request),
            "requestTimeMs" in e && (e.requestTimeMs = Math.round(R())),
            kg(a, d.method, e, {}));
          delete b[c];
        }
      }
  ...
  var zg = B("ytPubsub2Pubsub2Instance") || new M();
  M.prototype.subscribe = M.prototype.subscribe;
  M.prototype.unsubscribeByKey = M.prototype.U;
  M.prototype.publish = M.prototype.O;
  M.prototype.clear = M.prototype.clear;
  E("ytPubsub2Pubsub2Instance", zg);
  E(
    "ytPubsub2Pubsub2SubscribedKeys",
    B("ytPubsub2Pubsub2SubscribedKeys") || {}
  );
  E("ytPubsub2Pubsub2TopicToKeys", B("ytPubsub2Pubsub2TopicToKeys") || {});
  E("ytPubsub2Pubsub2IsAsync", B("ytPubsub2Pubsub2IsAsync") || {});
  ...
  function Bg() {
    var a;
    return null === (a = Ag()) || void 0 === a
      ? void 0
      : a.get("LAST_RESULT_ENTRY_KEY", !0);
  }
  function Cg(a) {
    this.h = void 0 === a ? !1 : a;
    (a = Bg()) || (a = { hasSucceededOnce: this.h });
    this.i = a;
    var b, c;
    null !== (b = Ag()) &&
      void 0 !== b &&
      b.h &&
      ((b = { hasSucceededOnce: this.i.hasSucceededOnce || this.h }),
      null === (c = Ag()) || void 0 === c
        ? void 0
  ...
  function Fg(a) {
    Eg ||
      (Dg.push({ type: "ERROR", payload: a }), 10 < Dg.length && Dg.shift());
  }
  function Gg(a, b) {
    Eg ||
      (Dg.push({ type: "EVENT", eventType: a, payload: b }),
      10 < Dg.length && Dg.shift());
  }
  function Hg(a, b) {
    ...
    this.args = [].concat(fa(c));
  }
  oa(Hg, Error);
  function Ig() {
    if (void 0 !== N("DATASYNC_ID", void 0)) return N("DATASYNC_ID", void 0);
    throw new Hg("Datasync ID not set", "unknown");
  }
  function Jg(a) {
  ...
  var S = {},
    Lg =
      ((S.AUTH_INVALID = "No user identifier specified."),
      (S.EXPLICIT_ABORT = "Transaction was explicitly aborted."),
      (S.IDB_NOT_SUPPORTED = "IndexedDB is not supported."),
      (S.MISSING_INDEX = "Index not created."),
      (S.MISSING_OBJECT_STORE = "Object store not created."),
      (S.DB_DELETED_BY_MISSING_OBJECT_STORE =
        "Database is deleted because an expected object store was not created."),
      (S.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons."),
      (S.QUOTA_EXCEEDED =
      ...
      (S.EXECUTE_TRANSACTION_ON_CLOSED_DB =
        "Can't start a transaction on a closed database"),
      (S.INCOMPATIBLE_DB_VERSION =
        "The binary is incompatible with the database version"),
      S),
    T = {},
    Mg =
      ((T.AUTH_INVALID = "ERROR"),
      (T.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING"),
      (T.EXPLICIT_ABORT = "IGNORED"),
      (T.IDB_NOT_SUPPORTED = "ERROR"),
      (T.MISSING_INDEX = "WARNING"),
      (T.MISSING_OBJECT_STORE = "ERROR"),
      (T.DB_DELETED_BY_MISSING_OBJECT_STORE = "WARNING"),
      (T.QUOTA_EXCEEDED = "WARNING"),
      (T.QUOTA_MAYBE_EXCEEDED = "WARNING"),
      (T.UNKNOWN_ABORT = "WARNING"),
      (T.INCOMPATIBLE_DB_VERSION = "WARNING"),
      T),
    U = {},
    Ng =
      ((U.AUTH_INVALID = !1),
      (U.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1),
      (U.EXPLICIT_ABORT = !1),
      (U.IDB_NOT_SUPPORTED = !1),
      (U.MISSING_INDEX = !1),
      (U.MISSING_OBJECT_STORE = !1),
      (U.DB_DELETED_BY_MISSING_OBJECT_STORE = !1),
      (U.QUOTA_EXCEEDED = !1),
      (U.QUOTA_MAYBE_EXCEEDED = !0),
      (U.UNKNOWN_ABORT = !0),
      (U.INCOMPATIBLE_DB_VERSION = !1),
      U);
  ...
  oa(V, Hg);
  function Og(a) {
    V.call(this, "MISSING_OBJECT_STORE", { Na: a }, Lg.MISSING_OBJECT_STORE);
  ...
  function Rg(a, b, c, d) {
    ...
    e.args = [{ name: "IdbError", kb: e.name, dbName: b, objectStoreNames: c }];
    e.level = "WARNING";
    return e;
  }
  function Sg(a, b, c) {
    return new V("IDB_NOT_SUPPORTED", {
      context: { caller: a, publicName: b, version: c },
    });
  }
  function Tg(a) {
    if (!a) throw Error();
    ...
    return new W(
      new Vg(function (b, c) {
        var d = [],
          e = a.length;
        0 === e && b(d);
        for (var f = { M: 0 }; f.M < a.length; f = { M: f.M }, ++f.M)
          Wg(
            W.resolve(a[f.M]).then(
              (function (g) {
                return function (h) {
                  d[g.M] = h;
                  e--;
  ...
  W.prototype.then = function (a, b) {
    var c = this,
      d = null !== a && void 0 !== a ? a : Ug,
      e = null !== b && void 0 !== b ? b : Tg;
    return new W(
      new Vg(function (f, g) {
        "PENDING" === c.state.status
          ...
          ? Xg(c, c, d, f, g)
          : "REJECTED" === c.state.status && Yg(c, c, e, f, g);
      })
    );
  };
  function Wg(a, b) {
  ...
  function Xg(a, b, c, d, e) {
    try {
      ...
      f instanceof W ? Zg(a, b, f, d, e) : d(f);
    } catch (g) {
      e(g);
    }
  }
  ...
  n.add = function (a, b, c) {
    return dh(this, [a], { mode: "readwrite", D: !0 }, function (d) {
      return d.objectStore(a).add(b, c);
    });
  };
  n.clear = function (a) {
    return dh(this, [a], { mode: "readwrite", D: !0 }, function (b) {
  ...
  n.count = function (a, b) {
    return dh(this, [a], { mode: "readonly", D: !0 }, function (c) {
      return c.objectStore(a).count(b);
    });
  };
  n.delete = function (a, b) {
    return dh(this, [a], { mode: "readwrite", D: !0 }, function (c) {
        ...
        switch (D.h) {
          ...
          case 6:
            return (
              (p = D.i),
              (x = Math.round(R())),
              hh(g, q, x, l, void 0, b.join(), h),
              D.return(p)
            );
          case 4:
            A = ta(D);
            v = Math.round(R());
            K = Rg(A, g.h.name, b.join(), g.h.version);
            if ((P = K instanceof V && !K.h) || l >= k)
              hh(g, q, v, l, K, b.join(), h), (m = K);
            D.v(2);
            break;
          case 3:
            return D.return(Promise.reject(m));
        }
      });
    });
  }
    ...
    e
      ? (e instanceof V &&
        ...
        e instanceof V &&
          ...
          Gg("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
  ...
  function kh(a, b) {
    return lh(a, { query: b }, function (c) {
  ...
  n.delete = function (a) {
    return a instanceof IDBKeyRange ? kh(this, a) : X(this.h.delete(a));
  };
  n.get = function (a) {
  ...
  n.index = function (a) {
    try {
      return new mh(this.h.index(a));
    } catch (b) {
      if (b instanceof Error && "NotFoundError" === b.name)
        throw new Pg(a, this.h.name);
      throw b;
    }
  };
  n.getName = function () {
  ...
  fh.prototype.objectStore = function (a) {
    a = this.h.objectStore(a);
    var b = this.j.get(a);
    b || ((b = new jh(a)), this.j.set(a, b));
    return b;
  };
  function mh(a) {
    this.h = a;
  ...
  n.delete = function (a) {
    return oh(this, { query: a }, function (b) {
  ...
  function nh(a) {
    return X(a).then(function (b) {
      return b ? new ph(a, b) : null;
    });
  }
  n = ph.prototype;
  n.advance = function (a) {
    this.cursor.advance(a);
    return nh(this.request);
  };
  ...
  function qh(a, b, c) {
    return new Promise(function (d, e) {
        ...
        try {
          ...
          m &&
            m(
              x,
              function (v) {
                return p.oldVersion < v && p.newVersion >= v;
              },
              A
            );
          A.done.catch(function (v) {
            e(v);
          });
        } catch (v) {
          e(v);
      ...
      g.addEventListener("success", function () {
        var p = g.result;
        k &&
          p.addEventListener("versionchange", function () {
            k(f());
          });
  ...
  th.prototype.delete = function (a) {
    a = void 0 === a ? {} : a;
    ...
    function a() {
      return I(c, function g() {
        ...
        return y(g, function (p) {
          switch (p.h) {
            case 1:
              return sa(p, 2), w(p, h.i(h.name, h.options.version, e), 4);
            case 4:
              k = p.i;
              a: {
                var x = h.options;
                for (
                  var A = u(Object.keys(x.ga)), v = A.next();
                  !v.done;
                  v = A.next()
                ) {
                  v = v.value;
                  var K = x.ga[v],
                    P = void 0 === K.Pa ? Number.MAX_VALUE : K.Pa;
                  if (
                    k.h.version >= K.ia &&
                    !(k.h.version >= P) &&
                    !k.h.objectStoreNames.contains(v)
                  ) {
                    x = v;
                    break a;
                  }
            ...
            case 2:
              ...
              if (
                m instanceof DOMException
                  ...
                  ? "VersionError" !== m.name
                  : !(m instanceof Object && "message" in m) ||
            ...
            case 9:
              q = p.i;
              t = q.h.version;
              if (void 0 !== h.options.version && t > h.options.version + 1)
                throw (q.close(), (h.l = !1), uh(h, t));
              return p.return(q);
            case 8:
              throw (b(), m);
          }
  ...
  var vh = new th("YtIdbMeta", {
    ga: { databases: { ia: 1 } },
    upgrade: function (a, b) {
      b(1) && a.h.createObjectStore("databases", { keyPath: "actualName" });
    },
  });
  function wh(a) {
    return I(this, function c() {
      ...
      return y(c, function (e) {
        if (1 == e.h) return w(e, vh.open(), 2);
        d = e.i;
        return e.return(
          dh(d, ["databases"], { D: !0, mode: "readwrite" }, function (f) {
            var g = f.objectStore("databases");
  ...
  function xh(a) {
    return I(this, function c() {
      var d;
      return y(c, function (e) {
        if (1 == e.h) return a ? w(e, vh.open(), 2) : e.return();
        d = e.i;
    ...
    return I(this, function b() {
      ...
      return y(b, function (f) {
        switch (f.h) {
          case 1:
            c = Bg();
            if (null === c || void 0 === c ? 0 : c.hasSucceededOnce)
              return f.return(new Cg(!0));
            var g;
            if ((g = Df))
              (g = /WebKit\/([0-9]+)/.exec(xb)),
                (g = !!(g && 600 <= parseInt(g[1], 10)));
            g &&
              ((g = /WebKit\/([0-9]+)/.exec(xb)),
              (g = !(g && 602 <= parseInt(g[1], 10))));
            if (g || Pb) return f.return(new Cg(!1));
            try {
              if (
                ((d = self),
                !(
            ...
            return w(f, wh(e), 4);
          case 4:
            return w(f, xh("yt-idb-test-do-not-use"), 5);
          case 5:
            return f.return(new Cg(!0));
          case 2:
            return ta(f), f.return(new Cg(!1));
        }
      });
    });
  }
  function Bh() {
    ...
    Eg = !0;
    return (yh = Ah().then(function (a) {
      Eg = !1;
      return a.isSupported();
    }));
  }
  function Ch() {
    return Bh().then(function (a) {
      return a ? zh : void 0;
    });
  }
  new (function () {
  ...
  function Dh(a) {
    ...
    if (!b) throw ((a = new V("AUTH_INVALID", { dbName: a })), Fg(a), a);
    b = Ig();
    ...
    return I(this, function f() {
      ...
      return y(f, function (m) {
        switch (m.h) {
          ...
          case 2:
            g = m.i;
            if (!g) throw ((h = Sg("openDbImpl", a, b)), Fg(h), h);
            Jg(a);
            k = c
            ...
            return w(m, wh(k), 5);
          case 5:
            return w(m, rh(k.actualName, b, d), 6);
          case 6:
            return m.return(m.i);
          case 3:
            return (l = ta(m)), sa(m, 7), w(m, xh(k.actualName), 9);
          case 9:
            m.h = 8;
            m.o = 0;
            break;
  ...
  function Hh(a, b) {
    ...
    return I(this, function d() {
      ...
      return y(d, function (g) {
        if (1 == g.h) return w(g, Ch(), 2);
        if (3 != g.h) {
          e = g.i;
          if (!e) return g.return();
          Jg(a);
          f = Dh(a);
          return w(g, sh(f.actualName, b), 3);
        }
        return w(g, xh(f.actualName), 0);
      });
    });
  }
  function Ih(a, b) {
  ...
  function Kh(a) {
    var b;
    return function () {
      b || (b = new Jh("LogsDatabaseV2", a));
      return b;
    };
  }
  Jh.prototype.i = function (a, b, c) {
    c = void 0 === c ? {} : c;
    return (this.options.ta ? Gh : Fh)(a, b, Object.assign({}, c));
  };
  Jh.prototype.delete = function (a) {
    a = void 0 === a ? {} : a;
    return (this.options.ta ? Ih : Hh)(this.name, a);
  };
  var Lh;
  function Mh() {
    if (Lh) return Lh();
    var a = {};
    Lh = Kh({
      ga: ((a.LogsRequestsStore = { ia: 2 }), a),
      ta: !1,
      upgrade: function (b, c, d) {
        c(2) &&
          b.h.createObjectStore("LogsRequestsStore", {
            keyPath: "id",
            autoIncrement: !0,
          });
        c(3);
  ...
  function Oh(a) {
    if (!Q("nwl_csi_killswitch") && 0.01 >= Math.random()) {
  ...
  var Th;
  function Uh() {
    Th || (Th = new tg("yt.offline"));
    return Th;
  }
  function Vh(a) {
    if (Q("offline_error_handling")) {
      var b = Uh().get("errors", !0) || {};
      b[a.message] = { name: a.name, stack: a.stack };
      a.level && (b[a.message].level = a.level);
      Uh().set("errors", b, 2592e3, !0);
    }
  }
  var Wh = ef("network_polling_interval", 3e4);
  function Y() {
    L.call(this);
    this.B = 0;
    this.N = this.l = !1;
  ...
  function Zh() {
    if (!Y.h) {
      var a = B("yt.networkStatusManager.instance") || new Y();
  ...
  n.Z = function (a, b) {
    return L.prototype.Z.call(this, a, b);
  };
  function Yh(a) {
    window.addEventListener("online", function () {
      return I(a, function c() {
        var d = this;
        return y(c, function (e) {
          if (1 == e.h) return w(e, d.L(), 2);
          if (d.N && Q("offline_error_handling")) {
            var f = Uh().get("errors", !0);
            if (f) {
              for (var g in f)
                if (f[g]) {
                  var h = new Hg(g, "sent via offline_errors");
                  h.name = f[g].name;
                  h.stack = f[g].stack;
                  h.level = f[g].level;
                  Je(h);
                }
              Uh().set("errors", {}, 2592e3, !0);
            }
          }
          e.h = 0;
        });
              ...
              switch (l.h) {
                ...
                case 3:
                  ...
                  h !== k.i &&
                    ((k.i = h),
                    k.i && k.l
                      ? Rd(k, "ytnetworkstatus-online")
                      : k.l && Rd(k, "ytnetworkstatus-offline"));
                  c(h);
                  va(l);
                  break;
                case 2:
  ...
  Y.prototype.listen = Y.prototype.Z;
  Y.prototype.enableErrorFlushing = Y.prototype.Da;
  Y.prototype.getWindowStatus = Y.prototype.da;
  Y.prototype.monitorNetworkStatusChange = Y.prototype.Oa;
  ...
  function ai(a) {
    ...
    c && c(a.Ea);
    a.Ma &&
      (c = B("yt.networkStatusManager.instance.enableErrorFlushing").bind(
        this.i
      )) &&
      c();
      ...
      a.ba
        ? ((this.ba = a.ba),
          c("ytnetworkstatus-online", function () {
            bi(b, "publicytnetworkstatus-online");
          }),
          c("ytnetworkstatus-offline", function () {
            bi(b, "publicytnetworkstatus-offline");
          }))
        : (c("ytnetworkstatus-online", function () {
            Rd(b, "publicytnetworkstatus-online");
          }),
          c("ytnetworkstatus-offline", function () {
            Rd(b, "publicytnetworkstatus-offline");
          }));
  }
  oa(ai, L);
  ai.prototype.J = function () {
    var a = B("yt.networkStatusManager.instance.isNetworkAvailable").bind(
      this.i
    );
    return a ? a() : !0;
  };
  ai.prototype.L = function (a) {
    return I(this, function c() {
      var d = this,
        e;
  ...
  var ci = 0,
    di = 0,
    ei,
    fi = z.ytNetworklessLoggingInitializationOptions || {
      isNwlInitialized: !1,
      databaseToken: void 0,
      potentialEsfErrorCounter: di,
      isIdbSupported: !1,
    };
  E("ytNetworklessLoggingInitializationOptions", fi);
  function gi(a, b) {
    function c(d) {
      var e = hi().J();
      if (!ii() || !d || (e && Q("vss_networkless_bypass_write"))) ji(a, b);
      else {
        var f = {
          url: a,
          options: b,
    ...
    b = void 0 === b ? {} : b;
    Q("skip_is_supported_killswitch")
      ? Ch().then(function (d) {
          c(d);
        })
      : c(li());
  ...
  function ni() {
    var a = this;
    if (!li()) throw Sg("throttleSend");
    ci ||
      (ci = jf(function () {
        return I(a, function c() {
          var d;
          return y(c, function (e) {
            if (1 == e.h) return w(e, Ph(), 2);
            if (3 != e.h)
              return (
                (d = e.i), d ? w(e, ki(d), 3) : (lf(ci), (ci = 0), e.return())
              );
            ci && ((ci = 0), ni());
            e.h = 0;
          });
    ...
    return I(this, function c() {
      ...
      return y(c, function (g) {
        switch (g.h) {
          case 1:
            d = li();
            if (!d) throw ((e = Sg("immediateSend")), e);
            if (void 0 === a.id) {
              g.v(2);
              break;
            }
            return w(g, Qh(a.id), 3);
          case 3:
            (f = g.i)
              ? (a = f)
              : Ke(Error("The request cannot be found in the database."));
          case 2:
            var h = a.timestamp;
            if (!(2592e6 <= R() - h)) {
              g.v(4);
          ...
          case 4:
            ...
            if (
              null ===
                (l =
                  null ===
                    (k = null === h || void 0 === h ? void 0 : h.options) ||
                  void 0 === k
                    ? void 0
                    : k.postParams) || void 0 === l
                ? 0
                : l.requestTimeMs
            )
              h.options.postParams.requestTimeMs = Math.round(R());
            a = h;
            if (!a) {
              g.v(0);
              break;
            ...
            return w(g, Sh(a.id), 8);
          case 8:
            ji(a.url, a.options, !!a.skipRetry), (g.h = 0);
        }
      });
    });
  }
  function oi(a) {
    var b = this;
    if (!li()) throw Sg("updateRequestHandlers");
    var c = a.options.onError ? a.options.onError : function () {};
    a.options.onError = function (e, f) {
      return I(b, function h() {
        return y(h, function (k) {
          switch (k.h) {
            case 1:
              if (
                !(
                  (B("ytNetworklessLoggingInitializationOptions")
                    ? fi.potentialEsfErrorCounter
                    : di) <= ef("potential_esf_error_limit", 10)
                )
              ) {
                k.v(2);
                break;
            ...
            case 2:
              ...
              return 1 > a.sendCount ? w(k, Rh(a.id), 8) : w(k, Sh(a.id), 4);
            case 8:
              jf(function () {
                hi().J() && ni();
              }, 5e3);
  ...
  function hi() {
    ei || (ei = new ai({ Ma: !0, Ea: !0 }));
    return ei;
  }
  function ji(a, b, c) {
    if (Q("networkless_with_beacon")) {
      var d = ["method", "postBody"];
      if (Object.keys(b).length > d.length) c = !0;
      else {
        c = 0;
        d = u(d);
        for (var e = d.next(); !e.done; e = d.next())
          b.hasOwnProperty(e.value) && c++;
        c = Object.keys(b).length !== c;
      }
      c ? vf(a, b) : Kf(a, void 0, b.postBody);
    } else c && 0 === Object.keys(b).length ? Hf(a) : vf(a, b);
  }
  function ii() {
    return B("ytNetworklessLoggingInitializationOptions")
      ? fi.isNwlInitialized
      : !1;
  }
  function li() {
  ...
  function pi(a) {
    var b = this;
    this.config_ = null;
    a ? (this.config_ = a) : qg() && (this.config_ = hg());
    gf(function () {
      yg(b);
    }, 5e3);
  }
  pi.prototype.isReady = function () {
    !this.config_ && qg() && (this.config_ = hg());
    return !!this.config_;
  };
  function kg(a, b, c, d) {
    function e(t) {
      ...
      if (
        ...
        var x = g.onSuccess,
          A = g.onFetchSuccess;
        g.onSuccess = function (v, K) {
          xg(p);
          x(v, K);
        };
        c.onFetchSuccess = function (v, K) {
          xg(p);
          A(v, K);
        };
      }
      try {
        t && d.retry && !d.qa.bypassNetworkless
          ? ((g.method = "POST"), d.qa.writeThenSend ? gi(q, g) : mi(q, g))
          : ((g.method = "POST"),
            g.postParams || (g.postParams = {}),
            vf(q, g));
      } catch (v) {
        if ("InvalidAccessError" == v.name)
          p && (xg(p), (p = 0)),
            Ke(Error("An extension is blocking network request."));
        else throw v;
      }
      p &&
        gf(function () {
    ...
    if (!a.isReady()) {
      var f = new Hg("innertube xhrclient not ready", b, c, d);
      Je(f);
      throw f;
    }
    var g = {
    ...
    var m = { alt: "json" };
    (a.config_.Ka && g.headers.Authorization) ||
  ...
  function qi(a, b) {
    var c = void 0 === c ? {} : c;
    var d = pi;
    N("ytLoggingEventsDefaultDisabled", !1) && pi == pi && (d = null);
    c = void 0 === c ? {} : c;
    var e = {},
      f = Math.round(c.timestamp || R());
    ...
    Q("log_sequence_info_on_gel_web") &&
      ...
      ((a = e.context),
      (b = c.sa),
      (lg[b] = b in lg ? lg[b] + 1 : 0),
      (a.sequence = { index: lg[b], groupKey: b }),
      c.hb && delete lg[c.sa]);
    (c.mb ? eg : ag)({ endpoint: "log_event", payload: e, H: c.H, X: c.X }, d);
  }
  var ri = [
    {
      fa: function (a) {
  ...
  function wi() {
    if (!vi) {
      ...
      a.K.length = 0;
      a.I.length = 0;
      ti.K && a.K.push.apply(a.K, ti.K);
      ti.I && a.I.push.apply(a.I, ti.I);
    }
    return vi;
  }
  var xi = new M();
  ...
  function Ai(a, b, c, d) {
    if (a)
      if (Array.isArray(a)) {
        ...
        for (
          d = 0;
          d < a.length && !(a[d] && ((e += Bi(d, a[d], b, c)), 500 < e));
          d++
        );
        d = e;
          ...
          if (a[e]) {
            ...
            g =
              ...
              ("clickTrackingParams" !== e && "trackingParams" !== e)
                ? 0
                : (f = yi(atob(f.replace(/-/g, "+").replace(/_/g, "/"))))
                ? Bi(e + ".ve", f, g, h)
                : 0;
            d += g;
            d += Bi(e, a[e], b, c);
  ...
  var Di = new Set(),
    ...
    Gi = 0,
    Hi = [],
    Ii = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];
  var Ji = {};
  function Ki(a) {
    return (
      Ji[a] ||
      (Ji[a] = String(a).replace(/\-([a-z])/g, function (b, c) {
  ...
  var Li = {},
    ...
    Ni = {};
  function Oi() {
    for (var a = u(Mi), b = a.next(); !b.done; b = a.next()) (b = b.value), b();
  }
  function Pi(a, b) {
    var c;
  ...
  function Si(a, b, c) {
    Ti ||
      ((Ti = {}),
      Se(window, "message", function (d) {
        a: {
          if (d.origin === Z(a, "host")) {
            try {
            ...
            if ((d = Ti[e.id]))
              (d.s = !0),
                d.s && (G(d.o, d.sendMessage, d), (d.o.length = 0)),
                d.ha(e);
          }
          e = void 0;
        }
  ...
  n.destroy = function () {
    this.h && this.h.id && (Li[this.h.id] = null);
    var a = this.l;
  ...
  function Yi(a, b, c) {
    ...
    a.s ? a.sendMessage(b) : a.o.push(b);
  }
  function Vi(a, b, c) {
    a.l.j || ((c = { target: a, data: c }), a.l.O(b, c), Qi(a.u + "." + b, c));
  }
  function Zi(a, b) {
    ...
    window.location.href &&
      G(["debugjs", "debugcss"], function (h) {
        var k = Kb(window.location.href, h);
        null !== k && (g[h] = k);
      });
    ...
    c.src = Z(a.i, "host") + ("/embed/" + Z(a.i, "videoId")) + "?" + Ib(g);
    return c;
  }
  n.ra = function () {
  ...
  n.setup = function (a, b) {
    ...
    if ((a = "string" === typeof a ? c.getElementById(a) : a))
      if (
        ...
        b.host || (b.host = c ? Gb(a.src) : "https://www.youtube.com"),
        (this.i = new Ri(b)),
        c ||
          ((b = Zi(this, a)),
          (this.m = a),
          ...
          (a = b)),
        (this.h = a),
        this.h.id || (this.h.id = "widget" + Ia(this.h)),
        (Li[this.h.id] = this),
        window.postMessage)
      ) {
        this.l = new M();
        ...
        for (var e in Ni) Ni.hasOwnProperty(e) && Xi(this, e);
      }
  };
  function Wi(a, b) {
    a.B[b] || ((a.B[b] = !0), Yi(a, "addEventListener", [b]));
  }
    ...
    if (this.h.contentWindow)
      for (var c = 0; c < b.length; c++)
        try {
          ...
          if (v.name && "SyntaxError" === v.name) {
            if (!(v.message && 0 < v.message.indexOf("target origin ''"))) {
              var d = void 0,
                e = v;
              d = void 0 === d ? {} : d;
              d.name = N("INNERTUBE_CONTEXT_CLIENT_NAME", 1);
              d.version = N("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0);
              var f = d || {};
              d = "WARNING";
              d = void 0 === d ? "ERROR" : d;
              if (e) {
                ...
                if (!(5 <= Ei)) {
                  ...
                  if (e.hasOwnProperty("args") && e.args && e.args.length)
                    for (
                      g = 0;
                      g < e.args.length &&
                      !((t = Ai(e.args[g], "params." + g, k, t)), 500 <= t);
                      g++
                    );
                  ...
                  if (Hi.length)
                    for (
                      g = 0;
                      g < Hi.length &&
                      !((t = Ai(Hi[g], "params.context." + g, k, t)), 500 <= t);
                      g++
                    );
                  navigator.vendor &&
                  ...
                  for (f = g.next(); !f.done; f = g.next())
                    if (((f = f.value), f.aa[e.name]))
                      for (
                        q = u(f.aa[e.name]), h = q.next();
                        !h.done;
                        h = q.next()
                      )
                        if (((l = h.value), (h = e.message.match(l.regexp)))) {
                          ...
                          for (m = 0; m < q.length; m++)
                            (l[q[m]] = h[m + 1]),
                              (e.params["params.error." + q[m]] = h[m + 1]);
                          e.message = f.fa(l);
                          break;
                        }
                  e.params || (e.params = {});
                  ...
                  hb("sample").constructor !== fb &&
                    (e.params["params.fconst"] = "true");
                  window.yterr &&
                    "function" === typeof window.yterr &&
                    window.yterr(e);
                  if (0 !== e.sampleWeight && !Di.has(e.message)) {
                    "ERROR" === d
                      ? (xi.O("handleError", e),
                        Q("record_app_crashed_web") &&
                          0 === Gi &&
                          1 === e.sampleWeight &&
                          (Gi++,
                          qi("appCrashed", {
                        ...
                        Fi++)
                      : "WARNING" === d && xi.O("handleWarning", e);
                    if (Q("kevlar_gel_error_routing")) {
                      g = d;
                      l = e;
                      b: {
                        f = u(Ii);
                        for (h = f.next(); !h.done; h = f.next())
                          if (Ef(h.value.toLowerCase())) {
                            f = !0;
                            break b;
                          }
                        f = !1;
                      ...
                      if (f) f = void 0;
                        ...
                        q = { pageUrl: window.location.href, kvPairs: [] };
                        N("FEXP_EXPERIMENTS") &&
                          (q.experimentIds = N("FEXP_EXPERIMENTS"));
                        if ((l = l.params))
                          for (
                        ...
                        l = N("SERVER_NAME", void 0);
                        m = N("SERVER_VERSION", void 0);
                        l &&
                          m &&
                          (q.kvPairs.push({ key: "server.name", value: l }),
                          q.kvPairs.push({ key: "server.version", value: m }));
                        f = { errorMetadata: q, stackTrace: h, logMessage: f };
                      }
                      f &&
                        (qi("clientError", f),
                        ("ERROR" === g ||
                          Q("errors_flush_gel_always_killswitch")) &&
                          cg());
                    }
                    if (!Q("suppress_error_204_logging")) {
                      f = e;
                      g = f.params || {};
                      d = {
                        urlParams: {
                      ...
                      if (d.postParams) {
                        ...
                        g = N("SERVER_NAME", void 0);
                        f = N("SERVER_VERSION", void 0);
                        g &&
                          f &&
                          ((d.postParams["server.name"] = g),
                          (d.postParams["server.version"] = f));
                      }
                      vf(N("ECATCHER_REPORT_HOST", "") + "/error_204", d);
                    }
                    Di.add(e.message);
                    Ei++;
                  }
  ...
  n.ha = function (a) {
    ...
    switch (b) {
      case "apiInfoDelivery":
        if (C(a)) for (var c in a) a.hasOwnProperty(c) && (this.F[c] = a[c]);
        break;
      case "infoDelivery":
        dj(this, a);
        break;
  ...
  function dj(a, b) {
    if (C(b)) for (var c in b) b.hasOwnProperty(c) && (a.playerInfo[c] = b[c]);
  }
  function ej(a, b) {
    G(
      b,
  ...
  function fj(a) {
    if ("iframe" !== a.tagName.toLowerCase()) {
      var b = Pi(a, "videoid");
      b &&
        ((b = { videoId: b, width: Pi(a, "width"), height: Pi(a, "height") }),
        new cj(a, b));
    }
  }
  ...
  E("YT.subscribe", function (a, b, c) {
    ke.subscribe(a, b, c);
    Ni[a] = !0;
    for (var d in Li) Li.hasOwnProperty(d) && Xi(Li[d], a);
  });
  ...
  Ui.prototype.setSize = Ui.prototype.setSize;
  Ui.prototype.getIframe = Ui.prototype.za;
  Ui.prototype.addEventListener = Ui.prototype.addEventListener;
  cj.prototype.getVideoEmbedCode = cj.prototype.getVideoEmbedCode;
  cj.prototype.getOptions = cj.prototype.getOptions;
  cj.prototype.getOption = cj.prototype.getOption;
  Mi.push(function (a) {
    var b = a;
    b || (b = document);
    a = Wa(b.getElementsByTagName("yt:player"));
    var c = b || document;
  ...
  var gj = z.onYTReady;
  gj && gj();
  var hj = z.onYouTubeIframeAPIReady;
  hj && hj();
  var ij = z.onYouTubePlayerAPIReady;
  ij && ij();
}.call(this));